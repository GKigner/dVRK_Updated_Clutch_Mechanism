...
CALIBRATION_FILE = './led_calibration.json'   # written by label_leds.py
...
if __name__ == "__main__":
    remove_processed_files('./fixed_roi_output/')
    process_folder('./led_data/', output_folder='./fixed_roi_output/')