...
CALIBRATION_FILE      = HERE / f"led_calibration_{side_tag}.json"
LINK3_WRT_CAMERA_FILE = LIVE_SCRIPTS_DIR / f"link3_wrt_camera_{side_tag}.txt"
...
def main():
    ...
    link3_wrt_camera           = np.loadtxt(str(LINK3_WRT_CAMERA_FILE))
