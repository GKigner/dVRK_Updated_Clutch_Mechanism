#!/usr/bin/env python3
# clutch_signal_right_6.py
# Self-contained live LED ON/OFF detector for the right arm.
#
...
# Configuration
# =========================
CALIBRATION_FILE      = "./led_calibration_right.json"
