...
DEBOUNCE_N = 5
# Initial published state at startup (0 = OFF / unclutched, 1 = ON / clutched).
# Starting at OFF is the safe default: the surgeon must actively clutch in
# before any state change is reported.
...
def main():
    ...
    print(f"Debounce: require {DEBOUNCE_N} consecutive readings to flip "
          f"(~{DEBOUNCE_N * 10} ms at 100 Hz). Initial state = {DEBOUNCE_INITIAL_STATE}.")
